      ...
      try {
         ...
         if (selectedSlots.time) {
            ...
            if (response.status === 200) {
               setdataa("Time slot not available. Please choose a different time.");
            } else {
               setdataa("done");
         ...
         <div className=" bg-white pl-20 pr-20 pt-2 pb-2 mb-5 fixed w-screen expand-lg h-[50px] flex flex-row-reverse ">
            ...
            <div>
               <Link to={"/AdminPatientDoctor"}>
                  <button className=" border-2 border-black p-2 ">Select Patient/Doctor</button>
               </Link>
            </div>
         </div>
